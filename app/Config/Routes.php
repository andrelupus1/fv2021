...
$routes->group('admin', function ($routes) {
    ...
    $routes->get('user/(:num)', 'Admin\User::index/$1');
    $routes->post('user', 'Admin\User::create');
    $routes->put('user/(:num)', 'Admin\User::update/$1');
    $routes->delete('user/(:num)', 'Admin\User::destroy/$1');
